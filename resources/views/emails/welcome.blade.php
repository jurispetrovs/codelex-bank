                                                    ...
                                                    <table style="border-radius: 3px; border-collapse: separate; background-color: #fcfcfc;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#fcfcfc">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10t es-p20r es-p20l" bgcolor="#fcfcfc" align="left">
                                                                <p>Hi {{ $user->name }}, we are very glad you chose us as your financial institution and hope you will take advantage of our wide variety of products, all designed to meet your specific needs.</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table style="border-color: #efefef; border-style: solid; border-width: 1px; border-radius: 3px; border-collapse: separate; background-color: #ffffff;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="center">
                                                                <p style="color: #64434a; font-size: 16px; line-height: 150%;">Name: {{ $user-> name }}<br>Surname: {{ $user->surname }}<br>Email: {{ $user->email }}<br></p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p35t es-p20r es-p20l" bgcolor="#fcfcfc" align="left">
                                                                <p><strong>Note: </strong>By deffault two-factor authentication is not enabled. If you want to protect your account, please enable two-factor authentication in your personal area.</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
